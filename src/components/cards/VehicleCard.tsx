...
import { Fuel, Gauge, MapPin, Star, Heart } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="p-5 space-y-3.5">
        ...
        <div className={`grid gap-2 text-xs font-bold text-muted-foreground/80 border-t border-b border-slate-100 dark:border-slate-800/60 py-3 bg-slate-50/50 dark:bg-slate-900/30 px-2 rounded-xl select-none grid-cols-2`}>
