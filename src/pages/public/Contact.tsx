...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact CAPL"
        description="Get in touch with the CAPL team for support, partnerships or dealer enquiries."
      />
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center max-w-xl mx-auto">
          ...
          <p className="text-muted-foreground mt-2">
            Questions about listings, dealer onboarding or partnerships? Drop us
            a note.
          </p>
        </div>
...
function Info({
  ...
  return (
    <div className="flex items-start gap-3">
      <div className="grid h-9 w-9 place-items-center rounded-lg gradient-primary text-white shrink-0">
        {icon}
      </div>
      <div>
