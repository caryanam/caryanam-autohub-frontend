...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title="CAPL — Verified Used Cars from Trusted Dealers"
      ...
      <section className="relative overflow-hidden text-white bg-slate-950">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 20%, rgba(37,99,235,0.4), transparent 50%), radial-gradient(circle at 80% 60%, rgba(37,99,235,0.3), transparent 50%)",
          }}
        />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/20 px-3 py-1 text-xs font-medium mb-5">
              <BadgeCheck className="h-3.5 w-3.5" /> India's #1 verified
              used-car marketplace
            </div>
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-black leading-[1.05] tracking-tight">
              India's Trusted Used Car
              <br />
              Dealer Marketplace
            </h1>
            <p className="mt-4 text-base md:text-lg text-white/80 max-w-2xl">
              Browse thousands of verified used cars from trusted dealers across
              India. Direct dealer contact. Real prices. No middlemen.
            </p>
          </motion.div>
          ...
          >
            ...
            <Button
              type="submit"
              size="lg"
              className="h-12 gradient-primary text-white border-0 hover:opacity-90 gap-2"
            >
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {QUICK_BRANDS.map((b) => (
              <Link
                ...
                className="px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-sm hover:bg-white/20 transition-colors"
              >
                {b}
              </Link>
            ))}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s) => (
            <div key={s.label} className="text-center md:text-left">
              <div className="text-3xl md:text-4xl font-black font-display text-gradient-primary">
                {s.value}
              </div>
        ...
        {featuredLoading ? (
          ...
          <div className="text-center py-8 rounded-2xl bg-slate-50 border border-slate-100 p-6">
            ...
            <Button
              ...
              className="mt-3 gradient-primary text-white border-0 hover:opacity-90"
            >
              Try Again
            </Button>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl gradient-premium text-white p-8 md:p-12 text-center shadow-premium">
            <h2 className="font-display text-3xl md:text-4xl font-black">
              Are you a used-car dealer?
            </h2>
            <p className="mt-3 text-white/80 max-w-xl mx-auto">
              List your inventory on CAPL and reach 50,000+ buyers every month.
