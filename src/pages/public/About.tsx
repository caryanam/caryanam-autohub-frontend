    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white py-24 px-4 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            CAPL was founded with a single mission — to make buying and selling
            used cars in India simple, safe, and transparent. We connect lakhs
            of buyers with verified dealers across 150+ cities.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-extrabold text-slate-900 mt-3 mb-5 leading-tight">
                Making Every Car Purchase
                <br />a Confident Decision
              </h2>
              <p className="text-slate-600 text-base leading-relaxed mb-4">
                ...
                untrustworthy sellers. CAPL was built to fix this.
              </p>
              <p className="text-slate-600 text-base leading-relaxed">
                ...
                your ride, CAPL puts the power back in your hands.
              </p>
            </div>
          ...
          {[
            {
              ...
              desc: "CAPL started as a small team of 5 people with a big dream — to clean up the used car industry in India.",
            },
            {
              year: "2021",
              title: "500 Dealers Onboarded",
              desc: "Rapid expansion across Maharashtra and Gujarat. Launched our dealer verification program.",
            },
            {
              year: "2022",
              title: "Pan-India Expansion",
              desc: "Reached 100+ cities. Launched our mobile app and crossed 1 lakh listings on the platform.",
            },
            {
              year: "2023",
              title: "1 Million Users",
              desc: "Milestone year — 10 lakh monthly active users, 1200+ verified dealers, and ₹500 Cr+ in transactions facilitated.",
            },
            {
              year: "2024",
              title: "AI-Powered Features",
              desc: "Introduced smart price recommendations, instant loan pre-approvals, and personalized search powered by AI.",
            },
          ].map((item, idx) => (
            <div
              key={item.year}
              className={`relative flex items-start gap-8 mb-12 ${idx % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}
            >
              ...
              <div className="flex-1 bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
                <div className="text-blue-600 font-bold text-xs mb-1">
                  {item.year}
                </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 to-slate-900 text-white text-center px-4">
        ...
        <p className="text-slate-300 mb-8 max-w-xl mx-auto">
          Browse thousands of verified listings from trusted dealers across
          India.
        </p>
        <a
          href="/cars"
