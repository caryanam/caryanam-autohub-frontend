...
function StatusBadge({ status }: { status: string }) {
  ...
  if (s === "ACTIVE")
    return (
      <Badge className="bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs font-bold rounded-full px-3">
        Active
      </Badge>
    );
  if (s === "INACTIVE")
    return (
      <Badge className="bg-red-50 text-red-600 border border-red-200 text-xs font-bold rounded-full px-3">
        Inactive
      </Badge>
    );
  if (s === "FEATURED")
    return (
      <Badge className="bg-yellow-50 text-yellow-700 border border-yellow-200 text-xs font-bold rounded-full px-3">
        Featured
      </Badge>
    );
  return (
