...
import type { InstagramAdminVehicleRequestDTO } from "@/types/instagram";
...
export default function AdminInstagramDealerRequests() {
  ...
  const rejectMutation = useAdminRejectInstagramRequests(parsedDealerId || 0);
  const approveMutation = useAdminBulkApproveInstagramPublish(parsedDealerId || 0);
    ...
    approveMutation.mutate(
      ...
      },
      {
        onSuccess: (data) => {
          ...
          navigate(`/admin/instagram-requests/batch/${data.batchId}`);
        },
        onError: (err) => {
  ...
  const renderApprovalStatus = (r: InstagramAdminVehicleRequestDTO) => {
  ...
  const renderPublishStatus = (r: InstagramAdminVehicleRequestDTO) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Button
          variant="ghost"
          onClick={() => navigate("/admin/instagram-requests")}
        ...
        <div className="flex items-center justify-between bg-slate-100 border border-slate-200 rounded-xl p-4 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-[#E1306C] hover:bg-[#E1306C]/90 text-white font-bold text-xs gap-2 rounded-xl h-9 px-5 cursor-pointer shadow-sm"
            >
