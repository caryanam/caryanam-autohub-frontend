...
export default function AdminInstagramDealerSummary() {
  ...
  const handleRowClick = (dealerId: number) => {
    navigate(`/admin/instagram-requests/dealer/${dealerId}`);
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-slate-900 flex items-center gap-2">
            <Instagram className="h-8 w-8 text-[#E1306C]" /> Instagram Requests
          </h2>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow>
                    ...
                    >
                      {search ? "No matching dealers found." : "No dealer Instagram requests found."}
                    </TableCell>
                  </TableRow>
                ) : (
                    ...
                    >
                      ...
                      <TableCell className="text-right py-4 pr-6" onClick={(e) => e.stopPropagation()}>
                        <Button
                          variant="ghost"
                          onClick={() => handleRowClick(s.dealerId)}
                          className="text-[#E1306C] hover:text-white hover:bg-[#E1306C] font-semibold text-xs gap-1.5 cursor-pointer rounded-xl h-8"
                        >
